...
const FEATURE_SLUG = 'no-syndromic-surveillance-ingestion-ed-otc-p';
const FEATURE_TITLE = 'No syndromic surveillance ingestion (ED, OTC pharmacy data)';
const PROJECT = 'AIPublicHealthEpidemiologyTracker';
