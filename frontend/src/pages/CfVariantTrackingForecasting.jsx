...
export default function CfVariantTrackingForecasting() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-variant-tracking-forecasting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Variant tracking & forecasting</h1>
