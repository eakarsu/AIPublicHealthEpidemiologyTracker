...
export default function CfZoonoticSpilloverRiskModel() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-zoonotic-spillover-risk-model', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Zoonotic spillover risk model</h1>
