...
export default function CfMultilanguageHealthMessaging() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multilanguage-health-messaging', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Multi-language health messaging</h1>
