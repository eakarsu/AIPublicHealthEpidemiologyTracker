...
export default function GapNoSyndromicSurveillanceIngestionEdOtcP() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-syndromic-surveillance-ingestion-ed-otc-p', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No syndromic surveillance ingestion (ED, OTC pharmacy data)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIPublicHealthEpidemiologyTracker - Gap feature</p>
