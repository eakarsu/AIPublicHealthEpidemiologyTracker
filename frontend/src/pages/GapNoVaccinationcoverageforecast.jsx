...
export default function GapNoVaccinationcoverageforecast() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-vaccinationcoverageforecast', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No /vaccination-coverage-forecast</h1>
